...
### 🐱 Chappie — Macに常駐するAI秘書 — [chappie](https://github.com/naruki0923/chappie)

画面の隅に小さな猫の姿で常駐する、**秘書のようなアシスタント**です。
「チャッピー、今日の予定」「請求書のファイル探して」「あれ買っといて」と声をかけるだけで、
**予定確認・ファイル検索・調べもの・Amazonの注文**まで代わりにこなします。
